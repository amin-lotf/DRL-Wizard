...
from drl_wizard.algorithms.algos.dqn_algo.trainer import Trainer
...
from drl_wizard.algorithms.utils.extras import make_train_env
...
class Runner(object):
    def __init__(
        ...
        self.algo_cfg: DQNConfig = config.algo_cfg
    ...
    def collect(self,obs,n_envs:int,masked_acts=None):
        raise NotImplementedError
